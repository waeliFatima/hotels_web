        ...
        <div style="width: 100%;margin: auto">
            ...
            <select  class="country" style="width: 230px;height: 35px;margin: 15px">
                ...
                while ($row_of_star = @mysqli_fetch_array($num_of_star)) {
                    ...
                    <option class="country" value="<?= $row_of_star['country'] ?>"><?= $row_of_star['country'] ?></option>
                    <?php
                }
                ?>
            </select>
            <select class="selectpicker city" data-live-search="true" style="width: 230px;height: 35px;margin: 15px">
